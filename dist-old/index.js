...
// src/DarkModeButton.tsx
var import_react3 = __toESM(require_react(), 1);

// node_modules/.pnpm/react-cosmos-ui@7.0.0/node_modules/react-cosmos-ui/dist/style/colors.js
var grey8 = createGreyColor(8);
var grey24 = createGreyColor(24);
var grey32 = createGreyColor(32);
var grey64 = createGreyColor(64);
var grey96 = createGreyColor(96);
var grey128 = createGreyColor(128);
var grey144 = createGreyColor(144);
var grey160 = createGreyColor(160);
var grey176 = createGreyColor(176);
var grey192 = createGreyColor(192);
var grey208 = createGreyColor(208);
var grey216 = createGreyColor(216);
var grey224 = createGreyColor(224);
var grey248 = createGreyColor(248);
var black60 = createGreyColor(0, 0.6);
var white3 = createGreyColor(255, 0.03);
var white10 = createGreyColor(255, 0.1);
var white20 = createGreyColor(255, 0.2);
var white95 = createGreyColor(255, 0.95);
var blue = "#3182ce";
...
// node_modules/.pnpm/styled-components@6.1.19_react-dom@19.1.1_react@19.1.1__react@19.1.1/node_modules/styled-components/dist/styled-components.esm.js
...
var ze = new ke();
var Me = Fe();
var $e = import_react.default.createContext({ shouldForwardProp: void 0, styleSheet: ze, stylis: Me });
var Be = $e.Consumer;
var Ge = import_react.default.createContext(void 0);
function Le() {
...
function Ye(e) {
  ...
  return import_react.default.createElement($e.Provider, { value: d }, import_react.default.createElement(Ge.Provider, { value: u2 }, e.children));
}
var qe = (function() {
  function e(e2, t) {
    var n = this;
...
var Qe = (function() {
  function e(e2, t, n) {
    this.rules = e2, this.staticRulesId = "", this.isStatic = (void 0 === n || n.isStatic) && Ze(e2), this.componentId = t, this.baseHash = z(Ke, t), this.baseStyle = n, ke.registerId(t);
  }
  return e.prototype.generateAndInjectStyles = function(e2, t, n) {
    ...
    if (this.isStatic && !n.hash) if (this.staticRulesId && t.hasNameForId(this.componentId, this.staticRulesId)) o2 = ie(o2, this.staticRulesId);
      ...
      var r2 = ae(Xe(this.rules, e2, t, n)), s2 = x(z(this.baseHash, r2) >>> 0);
...
var rt = {};
function it(e, r2, s2) {
  var i2 = se(e), a2 = e, c2 = !G(e), p2 = r2.attrs, d = void 0 === p2 ? _ : p2, h = r2.componentId, f2 = void 0 === h ? (function(e2, t) {
  ...
  function O2(e2, r3) {
    return (function(e3, r4, s3) {
      var i3 = e3.attrs, a3 = e3.componentStyle, c3 = e3.defaultProps, p3 = e3.foldedComponentIds, d2 = e3.styledComponentId, h2 = e3.target, f3 = import_react.default.useContext(et), m3 = Le(), y3 = e3.shouldForwardProp || m3.shouldForwardProp;
      ...
      for (var b2 in g3) void 0 === g3[b2] || "$" === b2[0] || "as" === b2 || "theme" === b2 && g3.theme === v2 || ("forwardedAs" === b2 ? w3.as = g3.forwardedAs : y3 && !y3(b2, S3) || (w3[b2] = g3[b2], y3 || true));
      var E2 = (function(e4, t) {
        var n = Le(), o2 = e4.generateAndInjectStyles(t, n.styleSheet, n.stylis);
        return false, o2;
      })(a3, g3);
      var N2 = ie(p3, d2);
      return E2 && (N2 += " " + E2), g3.className && (N2 += " " + g3.className), w3[G(S3) && !A.has(S3) ? "class" : "className"] = N2, s3 && (w3.ref = s3), (0, import_react.createElement)(S3, w3);
    })(D2, e2, r3);
  }
  O2.displayName = y2;
...
// node_modules/.pnpm/react-cosmos-ui@7.0.0/node_modules/react-cosmos-ui/dist/style/vars.js
var quick = 0.32;

// node_modules/.pnpm/react-cosmos-ui@7.0.0/node_modules/react-cosmos-ui/dist/components/buttons/shared.js
...
`;
var StyledLink = dt(StyledButton.withComponent("a"))`
  text-decoration: none;
`;
var iconSize = 16;
var StyledIcon = dt.span`
  width: ${iconSize}px;
  height: ${iconSize}px;
  padding: 2px 0 0 0;
...
// node_modules/.pnpm/react-cosmos-ui@7.0.0/node_modules/react-cosmos-ui/dist/components/buttons/IconButton32.js
var import_react2 = __toESM(require_react(), 1);
function IconButton32({ icon, title, disabled = false, selected = false, onClick }) {
  return import_react2.default.createElement(
    StyledButton,
    { bg: grey32, bgSelect: grey8, bgHover: grey24, color: grey224, colorSelect: grey248, title, selected, disabled, onClick },
    import_react2.default.createElement(StyledIcon, { color: selected ? grey176 : grey160 }, icon)
  );
}

// src/DarkModeButton.tsx
function DarkModeButton(props) {
  return /* @__PURE__ */ import_react3.default.createElement("div", { style: { display: "grid" } }, /* @__PURE__ */ import_react3.default.createElement("div", { style: { gridArea: "1 / 1 / -1 / -1" } }, /* @__PURE__ */ import_react3.default.createElement(
    IconButton32,
    {
      icon: /* @__PURE__ */ import_react3.default.createElement(MoonIcon, { filled: props.filled }),
      selected: props.selected,
      title: "Toggle dark mode",
      onClick: props.onClick
    }
  )), props.highlighted && /* @__PURE__ */ import_react3.default.createElement(
    "div",
    {
      style: {
        gridArea: "1 / 1 / -1 / -1",
...
// src/index.tsx
var { namedPlug, register } = (0, import_react_plugin.createPlugin)({
  name: "darkMode",
...
namedPlug(
  ...
  ({ pluginContext }) => {
    ...
    const storedDarkModeState = import_react4.default.useRef(
      getStoredDarkModeState(pluginContext)
    );
    const [darkMode, dispatch] = import_react4.default.useReducer(
      reduceDarkMode,
    ...
    import_react4.default.useEffect(() => {
      ...
      rendererCore.setGlobalFixtureState("darkMode", {
...
function reduceDarkMode(mode, action) {
  switch (action.kind) {
    case "toggle-dark":
      switch (mode) {
        case "dark":
          return action.defaultMode === "system" && !action.systemDarkMode ? "system" : "light";
        case "light":
          return "dark";
        case "system":
    ...
    case "toggle-light":
      switch (mode) {
        case "dark":
          return "light";
        case "light":
          return action.defaultMode === "system" && action.systemDarkMode ? "system" : "dark";
        case "system":
...
function useSystemDarkMode() {
  const [isDark, setIsDark] = import_react4.default.useState(darkModeMediaQuery.matches);
  import_react4.default.useEffect(() => {
...
var DARK_MODE_STORAGE_KEY = "darkMode";
function getStoredDarkModeState(context) {
  const { getMethodsOf } = context;
  const storage = getMethodsOf("storage");
  return storage.getItem(DARK_MODE_STORAGE_KEY) || null;
}
function setStoredDarkModeState(context, state) {
  const { getMethodsOf } = context;
  const storage = getMethodsOf("storage");
  storage.setItem(DARK_MODE_STORAGE_KEY, state);
}
export {
  register
};
